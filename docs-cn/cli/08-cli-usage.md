...
<table cellspacing=0 border=1>
    ...
    <tr>
        ...
        <td align="center" style=min-width:50px>指定客户端的创世区块配置文件路径 </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style=min-width:50px rowspan="2">点对点网络参数</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style=min-width:50px rowspan="4">交易参数</td>
    </tr>
    <tr>
...
* 在命令行中输入的账户密码会被保存在系统的日志中，容易造成密码泄露，因此**在生产环境中不要使用 `--password`, `-p`参数**
