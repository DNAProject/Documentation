...
| [get_blk_height](docs-cn/cli/06-restful-specification#_5-getblk_height)                 | 得到当前网络上的区块高度                 |
| [get_blk_hash](docs-cn/cli/06-restful-specification#_6-getblk_hash)                     | 得到该高度的区块哈希                     |
| [get_tx](docs-cn/cli/06-restful-specification#_7-gettx)                                 | 通过交易哈希得到该交易的信息             |
| [get_storage](docs-cn/cli/06-restful-specification#_8-getstorage)                       | 通过合约地址哈希和键得到对应的值         |
| [get_contract_state](docs-cn/cli/06-restful-specification#_10-getcontract_state)         | 得到合约状态                             |
| [get_sc_event_by_height](docs-cn/cli/06-restful-specification#_11-getsc_event_by_height) | 得到该高度区块上的智能合约执行结果       |
| [get_smtcode_evts](docs-cn/cli/06-restful-specification#_12-getsmtcode_evts)             | 通过交易哈希得到该交易的执行结果         |
| [get_blk_hgt_by_txhash](docs-cn/cli/06-restful-specification#_13-getblk_hgt_by_txhash)   | 通过交易哈希得到该交易落账的区块高度     |
| [get_merkle_proof](docs-cn/cli/06-restful-specification#_14-getmerkle_proof)             | 通过交易哈希得到该交易的 `merkle` 证明     |
| [get_version](docs-cn/cli/06-restful-specification#_20-getversion)                       | 得到版本信息                             |
| [post_raw_tx](docs-cn/cli/06-restful-specification#_21-post_raw_tx)                       | 向DNA区块链网络发送交易                       |
